          ...
          <MenuItems
            ...
            <div class="px-1 py-1">
              ...
              <button :class="[
                ...
                <AcademicCapIcon :active="active" class="w-5 h-5 mr-2 text-violet-400" aria-hidden="true" />Edit
              </button>
              </MenuItem>
              <MenuItem v-slot="{ active }">
              <button :class="[
                ...
                <DuplicateIcon :active="active" class="w-5 h-5 mr-2 text-violet-400" aria-hidden="true" />Duplicate
              </button>
              </MenuItem>
            </div>
            <div class="px-1 py-1">
              ...
              <button :class="[
                ...
                <ArchiveIcon :active="active" class="w-5 h-5 mr-2 text-violet-400" aria-hidden="true" />Archive
              </button>
              </MenuItem>
              <MenuItem v-slot="{ active }">
              <button :class="[
                ...
                <CheckCircleIcon :active="active" class="w-5 h-5 mr-2 text-violet-400" aria-hidden="true" />Move
              </button>
              </MenuItem>
            </div>
            ...
            <div class="px-1 py-1">
              ...
              <button :class="[
                ...
                <ArrowLeftIcon :active="active" class="w-5 h-5 mr-2 text-violet-400" aria-hidden="true" />Delete
              </button>
              </MenuItem>
            </div>
          </MenuItems>
